    ...
    */
    ...
    'middleware' => [
        ...
        'discussion' => [
            'index'   => [],
            'show'    => [],
            'create'  => ['role:bde|student'],
            'store'   => ['role:bde|student'],
            'destroy' => ['role:bde|student'],
            'edit'    => ['role:bde|student'],
            'update'  => ['role:bde|student'],
        ],
        'post' => [
            'index'   => [],
            'show'    => [],
            'create'  => ['role:bde|student'],
            'store'   => ['role:bde|student'],
            'destroy' => ['role:bde|student', 'bde-user_id'],
            'edit'    => ['role:bde|student'],
            'update'  => ['role:bde|student', 'bde-user_id'],
        ],
        'category' => [
            'show' => [],
        ],
